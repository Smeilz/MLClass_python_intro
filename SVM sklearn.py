...
import numpy as np
X = np.array([[-1, -1, 2], [-2, -1, 4], [1, 1, 5], [2, 1, 2], [-2, -5, -6]]) #Тут массив из 3
y = np.array([2, 1, 5, 2, 6])
...
print(clf.classes_) #Сортировка вероятности будет такая, как указано в clf.classes
print(clf.predict_proba([[-1, -1, 2]])) #Смотрим минимальное число- это минимальное расстояние
print(clf.decision_function([[-1, -1, 2]])) #Смотрим максимальное число
